...
export default class Target extends Component{
    ...
    start(e){
        ...
        this.x = e.clientX;
        this.y = (e.clientY - (((document.body.getBoundingClientRect().height) / 10) * 7));
    ...
    move(e){
        ...
        e.clientY = e.clientY - (((document.body.getBoundingClientRect().height) / 10) * 7);
        e.clientY = (e.clientY < 0 ? 0 : e.clientY)
        ...
        let step = ((document.body.getBoundingClientRect().height / 10) * 7) / ((document.body.getBoundingClientRect().height / 10) * 3);

        delta.clientY = delta.clientY + this.top
        delta.clientY = Math.min(Math.max(delta.clientY, 0), (((document.body.getBoundingClientRect().height) / 10) * 3));
        
        this.oldTop = delta.clientY;

        this.setState({angle: angle, top: delta.clientY * step});
    }
